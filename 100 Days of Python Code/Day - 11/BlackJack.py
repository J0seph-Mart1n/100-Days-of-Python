...
while play_game:
    ...
    if play == 'y':
      ...
      player_cards = []
      CPU_cards = []
      player_choice = random.choices(cards, weights=None, k=2)
      CPU_choice = random.choices(cards, weights=None, k=2)
  
      player_cards.extend(player_choice)
      CPU_cards.extend(CPU_choice)
      ...
      while True:
          ...
          if player_score > 21 or player_score == 21:
              break
          elif CPU_score > 21 or CPU_score == 21:
              break
      ...
      if player_score <= 21 and CPU_score <= 21:
          if player_score > CPU_score:
              ...
              print("The CPU got BlackJack. You Lost.")
          else:
              print("Draw")
      if player_score > 21:
